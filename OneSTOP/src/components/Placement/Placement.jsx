...
import JSONDATA from './PlacementInfo.json';
    ...
    return (
        <>
            <div className="SearchBarContainer">
                ...
                />
                <a id="search-institute" href="admin/placement-records/Placement_Stats" target="_blank">Search</a>
            </div>
            <div id="institute-match">
                {JSONDATA.filter((val)=>{
                    if(searchTerm == ""){
                        return null;
                    ...
                    return (
                        <p className="matched-institute" onClick={ ()=>{
